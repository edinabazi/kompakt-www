export const site = {
  ...
  downloadUrl:
    "https://github.com/edinabazi/Kompakt/releases/latest/download/Kompakt.dmg",
  assets: {
    appIcon: "/brand/kompakt-icon.png",
    appleIcon: "/menu-icons/apple.logo.svg",
    githubIcon: "/brand/github.svg",
    favicon: "/favicon.png",
